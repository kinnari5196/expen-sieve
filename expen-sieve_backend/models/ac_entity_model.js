...
return db.query("insert into ac_entity(name,description,gst_no) values(?,?,?)",[Ac_entity.name,Ac_entity.description,Ac_entity.gst_no],callback);
},*/
...
updateEntity:function(id,Ac_entity,callback){
  return db.query("update ac_entity set name=?,description=?,gst_no=? where entity_id=?",[Ac_entity.name,Ac_entity.description,Ac_entity.gst_no,id],callback);
 }
